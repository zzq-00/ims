        ...
        <a-row :gutter="16">
          <a-col :span="6">
            <a-form-item label="机构状态">
              <DicSelect dicType="SUP_APROVE_STATUS" :allowClear="true" @change="searchHandle" v-decorator="['approvalStatus', {initialValue: ''}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6">
          ...
          <a-col :span="6">
            <a-form-item label="管理机构">
              <OrgSelect dicType="4" :allowClear="true" @change="searchHandle" v-decorator="['orgCode', {initialValue: '86'}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6">
          ...
          <a-col :span="6">
            <a-form-item label="服务类型">
              <DicSelect dicType="BELONG_SERVICE_TYPE" :allowClear="true" @change="searchHandle" v-decorator="['serviceType', {initialValue: ''}]" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="16">
          <a-col :span="12" :offset="11">
            ...
            <a-button type="" :disabled="!selectedRows.length" class="editable-add-btn" @click="revokeRecord" style="float:right;margin-right:10px;">撤销</a-button>
            <a-button type="" class="editable-add-btn" @click="searchHandle" style="float:right;margin-right:10px;">查询</a-button>
            <a-button type="primary" class="editable-add-btn" @click="addOrg" style="float:right;margin-right:10px;">新建</a-button>
          </a-col>
        </a-row>
      </a-form>
    </a-card>
