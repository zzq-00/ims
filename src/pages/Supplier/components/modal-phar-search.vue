      ...
      <a-row :gutter="16">
        ...
        <a-col :span="6">
          <a-form-item label="所在省">
            <AddressSelect dicType="0" v-decorator="['proviceCode', {initialValue: ''}]" />
          </a-form-item>
        </a-col>
        <a-col :span="6">
          <a-form-item label="所在市">
            <AddressSelect :dicType="this.filterForm.getFieldValue('proviceCode')" v-decorator="['cityCode', {initialValue: ''}]" />
          </a-form-item>
        </a-col>
        <a-col :span="6">
          <a-form-item label="合作方式">
            <DicSelect dicType="COOPERATE_WAY" v-decorator="['cooperationType', {initialValue: ''}]" />
          </a-form-item>
        </a-col>
        <a-col :span="6">
          <a-form-item label="管理机构">
            <OrgSelect dicType="4" v-decorator="['manageOrgCode', {initialValue: ''}]" />
          </a-form-item>
        </a-col>
        <a-col :span="6">
          <a-form-item label="机构类型">
            <DicSelect dicType="SUPPLIER_SUB_TYPE" v-decorator="['manageOrgType', {initialValue: '18'}]" />
          </a-form-item>
        </a-col>
      </a-row>
      <a-row :gutter="16">
        <a-col :span="12" :offset="11">
          <a-button type="primary" class="editable-add-btn" @click="save" style="float:right;margin-right:10px;">确认</a-button>
