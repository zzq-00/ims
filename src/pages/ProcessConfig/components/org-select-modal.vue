<template>
    <div>
        <a-modal v-model="formModal" style="top: 30px;" :width="modalWidth" title="健管中心/VIP诊疗室查询">
            <a-card>
                <a-form :form="filterForm" :labelCol="filterFormLayout.labelCol" :wrapperCol="filterFormLayout.wrapperCol">
                    <a-row :gutter="16">
                        ...
                        <a-col :span="6">
                            <a-form-item label="机构所在省">
                                <AddressSelect dicType="0" v-decorator="['orgPrivince', {initialValue: ''}]" />
                            </a-form-item>
                        </a-col>
                        <a-col :span="6">
                            <a-form-item label="机构所在市">
                                <AddressSelect :hasCascadeDefault='false' :dicType="this.filterForm.getFieldValue('orgPrivince')" v-decorator="['orgCity', {initialValue: ''}]" />
                            </a-form-item>
                        </a-col>
                    </a-row>
                    <a-row :gutter="16">
...
export default {
	...
	data () {
		return {
			...
			loading: false,
			columns: [
				{ title: "医疗机构编码", dataIndex: "sorgCode", width: 100 },
				{ title: "医疗机构名称", dataIndex: "sorgName", width: 100 },
